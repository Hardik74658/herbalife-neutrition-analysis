...
function TestinomialCards() {
  ...
  return (
    <div className="h-[40rem] w-full dark:bg-transperent  relative flex flex-col items-center justify-center overflow-hidden">
    <h2 className="text-3xl font-bold text-center mb-8 z-10 text-black dark:text-whiet">Hear our Harmony: Voices of Success</h2>
